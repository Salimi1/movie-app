...
const Cart = ({info}) => {
    const {title, poster_path, vote_average, release_date} = info
    ...
    return (
        <div style={{width: '200px'}} className='card text-white m-3'>
            ...
            <div className='card-img-overlay d-flex flex-column justify-content-end'>
                <div className='row'>
                    <h6 className='card-title py-1 col-12 rounded-4 bg-warning col-12'>{titleShorter(title)}...</h6>
                    <h6 className='card-title py-1 mt-2 col-12  rounded-4' style={{backgroundColor: '#ffffff78'}}>Rateing: {vote_average}</h6>
                    <h6 className='card-title mt-3 col-8'>{release_date}</h6>

...
const ActorCart = ({data}) => {
    ...
    return (
        <div className='col-6 col-sm-4 mx-4 ms-md-0 col-md-3 col-lg-2 ms-3 card mt-4 p-0 text-dark'>
            <img alt='ActorCart' className='card-img-top h-75 w-100' src={profile_path ? `${IMAGE_URL}/${profile_path}` : 'https://wemme-events.de/wp-content/themes/wemme/assets/images/no_image.jpg'} />
